"""
Django settings for HerokuDjangoTemplate project.
...
SECRET_KEY = 'django-insecure-3gsbej46#+!_^dvtu^k6d&5u+wflnjoc+6s%ow(qmu&+0_p3_y'
...
ROOT_URLCONF = 'HerokuDjangoTemplate.urls'
...
WSGI_APPLICATION = 'HerokuDjangoTemplate.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'Nome_do_banco_de_dados',#nome do banco de dados criado
